...
(function(
	...
	if( 1  && ( 1  ||  1 )){
		var domOn = function(node, eventName, ieEventName, handler){
				...
				// return a function that will disconnectManager the listener.
...
var connect = {
	...
	connect:function(obj, event, context, method, dontFix){
		...
		//		remove this connection with `dojo.disconnectManager`.
		//
		// obj: Object?
		...
		//
		// example:
		//		Using return value for disconnectManager:
		//	|	var link = dojo.connect(obj, "onchange", ui, "update");
		//	|	...
		//	|	dojo.disconnectManager(link);
		//
		// example:
	...
	connectPublisher:function(topic, obj, event){
		...
		//		dojo.disconnectManager() to disable subsequent automatic publication on
		//		the topic.
		// topic: String
		//		The name of the topic to publish.
		// obj: Object?
