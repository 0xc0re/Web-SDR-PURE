define("dojox/mdnd/adapter/DndToDojo", ["dojo/_base/kernel",
		...
		null,
	{
		...
		_getIndexDojoArea: function(/*node*/area){
			...
			// 0 && console.log('dojox.mdnd.adapter.DndToDojo ::: _getIndexDojoArea');
			if(area){
		...
		_initCoordinates: function(/*DOMNode*/area){
			...
			// 0 && console.log('dojox.mdnd.adapter.DndToDojo ::: _initCoordinates');
			if(area){
		...
		register: function(/*DOMNode*/area, /*String*/ type, /*Boolean*/ dojoTarget){
			...
			// 0 && console.log("dojox.mdnd.adapter.DndToDojo ::: registerDojoArea", area, type, dojoTarget);
		...
		unregisterByNode: function(/*DOMNode*/area){
			...
			// 0 && console.log("dojox.mdnd.adapter.DndToDojo ::: unregisterByNode", area);
		...
		unregisterByType: function(/*String*/type){
			...
			// 0 && console.log("dojox.mdnd.adapter.DndToDojo ::: unregisterByType", type);
			if(type){
				var tempList = [];
		...
		unregister: function(){
			...
			// 0 && console.log("dojox.mdnd.adapter.DndToDojo ::: unregister");
			this._dojoList = [];
		},
		...
		refresh: function(){
			...
			// 0 && console.log("dojox.mdnd.adapter.DndToDojo ::: refresh");
		...
		_getHoverDojoArea: function(/*Object*/coords){
			...
			// 0 && console.log("dojox.mdnd.adapter.DndToDojo ::: _getHoverDojoArea");
		...
		onMouseMove: function(/*DOMEvent*/e){
			...
			// 0 && console.log("dojox.mdnd.adapter.DndToDojo ::: onMouseMove");
			var coords = {
				'x': e.pageX,
				'y': e.pageY
			};
		...
		isAccepted: function(/*DOMNode*/draggedNode, /*Object*/ target){
			...
			// 0 && console.log("dojox.mdnd.adapter.DndToDojo ::: isAccepted");
			return true;
		},
		...
		onDragEnter: function(/*DOMEvent*/e){
			...
			// 0 && console.log("dojox.mdnd.adapter.DndToDojo ::: onDragEnter");
			...
			if(this._currentDojoArea.dojo){
				...
				connect.disconnect(this._dojoxManager._dragItem.handlers.pop());
				//disconnectManager onmousemove of moveable item
				// 0 && console.info("before",this._dojoxManager._dragItem.item.events.pop());
				...
				// hide dragNode :
				// disconnectManager the dojoDndAdapter if it's initialize
		...
		onDragExit: function(/*DOMEvent*/e){
			...
			// 0 && console.log("dojox.mdnd.adapter.DndToDojo ::: onDragExit",e, this._dojoxManager._dragItem.item);
			...
			if(this._oldDojoArea.dojo){
				...
				if(this.accept){
					// disconnectManager the mouseUp event.
					if(this._moveUpHandler){
		...
		onDrop: function(/*DOMEvent*/e){
			...
			// 0 && console.log("dojox.mdnd.adapter.DndToDojo ::: onDrop", this._currentDojoArea);
			if(this._currentDojoArea.dojo){
