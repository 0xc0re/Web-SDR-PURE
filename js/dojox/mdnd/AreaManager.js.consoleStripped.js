define("dojox/mdnd/AreaManager", ["dojo/_base/kernel",
		...
		null,
	{
		...
		constructor: function(){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: constructor");
			this._areaList = [];
		...
		init: function(){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: init");
		...
		registerByNode: function(/*DOMNode*/area, /*Boolean*/notInitAreas){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: registerByNode", area);
		...
		registerByClass: function(){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: registerByClass");
		...
		unregister: function(/*DOMNode*/area){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: unregister");
			var index = this._getIndexArea(area);
			if(index != -1){
		...
		_addMoveableItem: function(/*DOMNode*/node){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: _addMoveableItem");
		...
		_deleteMoveableItem: function(/*Object*/ objItem){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: _deleteMoveableItem", objItem);
			// disconnectManager the handle
		...
		_getIndexArea: function(/*DOMNode*/area){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: _getIndexArea");
			if(area){
		...
		_searchDragHandle: function(/*DOMNode*/node){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: _searchDragHandle");
			if(node){
		...
		addDragItem: function(/*DOMNode*/area, /*DOMNode*/node, /*Integer*/index, /*Boolean*/notCheckParent){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: addDragItem");
			var add = true;
			if(!notCheckParent){
		...
		removeDragItem: function(/*DOMNode*/area, /*DOMNode*/node){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: removeDragItem");
			var index = this._getIndexArea(area);
			if(area && index !== -1){
		...
		_getChildren: function(/*DOMNode*/area){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: _getChildren");
			var children = [];
		...
		_setMarginArea: function(/*Object*/area,/*DOMNode*/node){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: _setMarginArea");
		...
		findCurrentIndexArea: function(/*Object*/coords, /*Object*/size){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: findCurrentIndexArea");
		...
		onDragStart: function(/*DOMNode*/node, /*Object*/coords, /*Object*/size){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: onDragStart");
			if(this.autoRefresh){
				this._dropMode.updateAreas(this._areaList);
			}
		...
		onDragEnter: function(/*Object*/coords, /*Object*/size){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: onDragEnter", coords, size);
		...
		onDragExit: function(/*Object*/coords, /*Object*/size){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: onDragExit");
			this._accept = false;
		},
		...
		onDrag: function(/*DOMNode*/node, /*Object*/coords, /*Object*/size, /*Object*/mousePosition){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: onDrag", node, ",", coords,size);
		...
		placeDropIndicator: function(/*Object*/coords, /*Object*/size){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: placeDropIndicator");
			//keep old drop Index
		...
		onDropCancel: function(){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: onDropCancel");
			if(!this._accept){
		...
		onDrop: function(/*DOMNode*/node){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: onDrop");
			//dropCancel
			this.onDropCancel();
			...
			// disconnectManager onDrop handler
		...
		destroy: function(){
			...
			// 0 && console.log("dojox.mdnd.AreaManager ::: destroy");
