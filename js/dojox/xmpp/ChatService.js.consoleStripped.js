...
/*
		if (msg.xhtml){
			if (msg.xhtml.getAttribute('xmlns') != dojox.xmpp.xmpp.XHTML_IM_NS){
				// 0 && console.log("ChatService::sendMessageToDsp() - Cannot use this xhtml without the propper xmlns");
			}else{
				//FIXME do this in some portable way
				// 0 && console.log("ChatService::sendMessageToDsp() - FIXME Serialize XHTML to string: ", msg.xhtml.toString());
			}
		}
*/
