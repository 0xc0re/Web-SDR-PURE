...
define([
	...
	var _WidgetBase = declare("dijit._WidgetBase", [Stateful, Destroyable], {
		...
		connect: function(/*Object|null*/ obj, /*String|Function*/ event, /*String|Function*/ method){
			...
			//		and registers for disconnectManager() on widget destroy.
			//
			...
			//		destruction.
			// returns:
			//		A handle that can be passed to `disconnectManager` in order to disconnectManager before
...
define(["dojo/_base/lang", "dojo/_base/array", "dojo/_base/declare", "dojo/_base/connect"], 
	...
	return declare("dojox.charting.plot2d._PlotEvents", null, {
		...
		resetEvents: function(){
			// summary:
			//		Reset all events attached to our plotEvent (i.e. disconnectManager).
